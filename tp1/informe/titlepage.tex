\begin{titlepage}
    ...
    {\large \bfseries PL/pgSQL, procesamiento y optimizacón de consultas}\\[0.4cm] % Title of your document
    \HRule \\[1.5cm]
    ...
    {\large 7 de Abril de 2018}\\[1cm] % Date, change the \today to a set date if you want to be precise
